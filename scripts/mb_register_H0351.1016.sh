...
antsRegistration --dimensionality 3 --float 0 --collapse-output-transforms 1 --verbose -n BSpline[5] \
  ...
  --initial-moving-transform [templates/model_extracted_nocb_t1.nii.gz,${movingfile},1] \
  --transform Rigid[0.1]      --metric Mattes[templates/model_extracted_nocb_t1.nii.gz,${movingfile},1,64,Regular,1] --metric Mattes[templates/model_extracted_nocb_t2.nii.gz,${movingfile2},1,64,Regular,1] \
  ...
  --transform Similarity[0.1] --metric Mattes[templates/model_extracted_nocb_t1.nii.gz,${movingfile},1,64,Regular,1] --metric Mattes[templates/model_extracted_nocb_t2.nii.gz,${movingfile2},1,64,Regular,1] \
  --convergence [1600x1600x1600x1600x1600x1600x1600x1600x1600x800x400x200x100x100x100,1e-6,10,1] --shrink-factors 4x4x4x4x4x4x4x4x4x4x4x4x2x1x1 --smoothing-sigmas 5.520591701872124x5.095930801728114x4.671269901584105x4.2466090014400955x3.8219481012960856x3.3972872011520763x2.972626301008067x2.547965400864057x2.1233045007200477x1.6986436005760381x1.2739827004320285x0.8493218002880191x0.42466090014400953x0.21233045007200477x0mm  \
  --transform Affine[0.1]     --metric Mattes[templates/model_extracted_nocb_t1.nii.gz,${movingfile},1,64,Regular,1] --metric Mattes[templates/model_extracted_nocb_t2.nii.gz,${movingfile2},1,64,Regular,1] \
  ...
  --transform Affine[0.05]     --metric Mattes[templates/model_extracted_nocb_t1.nii.gz,${movingfile},1,64,Regular,1] --metric Mattes[templates/model_extracted_nocb_t2.nii.gz,${movingfile2},1,64,Regular,1] \
...
antsRegistration --dimensionality 3 --float 0 --collapse-output-transforms 1 --verbose -n BSpline[5] \
  ...
  --transform SyN[0.1,3,0] --metric CC[templates/model_extracted_cbonly_t1.nii.gz,${movingfile},1,6] --metric CC[templates/model_extracted_cbonly_t2.nii.gz,${movingfile2},1,6] \
